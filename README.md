...
`npm run sim` is the tuning instrument: it plays all 671 boards with an omniscient tier-order
...
the same invariants, and `npm run sim` clears all 671 of them at full HP.
