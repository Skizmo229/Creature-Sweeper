...
```bash
npm run dev       # play it
npm test          # 267 tests, including the invariants below
...
the same invariants, and `npm run sim` clears all 517 of them at full HP.
...
("clear 25 boards, anywhere") is a claim about time served, and it is what the eight variant
